...
[oidc-discord.md](oidc-discord.md) for the hosted Discord IdP. GitHub is the one
provider that is *not* OIDC — it has its own guide,
[oidc-github.md](oidc-github.md).
