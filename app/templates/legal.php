...
<?= $outbound('https://www.aboutads.info/choices/', 'legal.cookies.link_aboutads') ?>
  ...
  <?php elseif ($page === 'legal-notice'): ?>
    ...
    <?php // AGPL §13 (#73) : le service tournant sur un logiciel sous AGPL doit
          ...
          //
          // L'URL reste en dur, comme dans le partiel `github-link` : une
          // instance tierce qui modifie le code doit de toute façon réécrire
          // ces mentions légales (éditeur, hébergeur, contact) — et donc cette
          // section, qui doit alors pointer vers SES sources, pas vers l'amont. ?>
